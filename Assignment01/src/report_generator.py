...
Module for generating reports from database data
"""
...
class ReportGenerator:
    ...
    Class for generating reports from database data
    """
    ...
    def __init__(self, db_path, output_dir):
        ...
        # Initialize chart and HTML generator objects
    ...
    def generate_daily_report(self, date=None):
        ...
        Args:
            date (datetime.date, optional): Ngày tạo báo cáo. Mặc định là hôm nay.
                                          Date to generate report for. Default is today.
    ...
    def generate_weekly_report(self, end_date=None):
        ...
        Args:
            end_date (datetime.date, optional): Ngày kết thúc của tuần. Mặc định là hôm nay.
                                              End date of the week. Default is today.
        ...
        try:
            ...
            if not weekly_stats:
                ...
                self.logger.warning(f"No data to generate report from {start_date} to {end_date}")
                return None
    ...
    def _fetch_daily_logs(self, date):
        ...
        try:
            ...
            self.logger.error(f"Error fetching daily logs: {e}")
            return []
    ...
    def _fetch_date_range_stats(self, start_date, end_date):
        ...
        try:
            ...
            self.logger.error(f"Error fetching date range statistics: {e}")
            return []
